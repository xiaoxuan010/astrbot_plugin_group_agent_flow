...
- `context_renderers.py` contains the pluggable context projections (`xml_delta` default and
  `line_messages`). Renderers return OpenAI-style message dictionaries and do not read storage
